...
void fourth()
{
	...
	cout << "number = " << 15 << endl;
	base10to16(15);
	cout << "number = " << 100202021 << endl;
	base10to16(100202021);
}
...
void seventh()
{
	...
	cout << "line: " << s << endl;
	resize(s, 1/2);
	cout << "after 1/2x resizing: " << s << endl;
}
...
{
	cout << "eights" << endl;
	cout << "3.14159 in register 'x', function: sin" << endl;
	Calculator calculator1 = {mySin, 3.14159};
	calculator1.calculate();
	cout << "sin(3.14159): " << calculator1.register_y << endl;
